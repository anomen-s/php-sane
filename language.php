...
$lang[4] = array("Область сканирования", // 0
                 "Слева",                // 1
		 "От верха",             // 2
		 "Ширина",               // 3
		 "Высота",               // 4
		 ...
		 "Сканировать",          // 27
		 "Очистить",             // 28
		 "Просмотр<br><br>Нет выделения<br>Нет формата файла<br>Нет разрешения DPI", // 29
		 "Максимальные значения сканирования<br><br>DIN-A4<br>Разрешение DPI = 5 - 600",  // 30
		 "Устройство сканирования",      // 31
		 "ОШИБКА",               // 32
...
$lang[5] = array("Область сканування", // 0
		 "Зліва",                // 1
		 "З верху",             // 2
		 "Ширина",               // 3
		 "Висота",               // 4
		 ...
		 "Сканувати",          // 27
		 "Очистити",             // 28
		 "Перегляд<br><br>Немає виділення<br>Немає формату файлу<br>Немає роздільної здатності DPI", // 29
		 "Максимальні значення сканування<br><br>DIN-A4<br>Роздільна здатність DPI = 5 - 600",  // 30
		 "Пристрій сканування",      // 31
		 "Помилка",               // 32
